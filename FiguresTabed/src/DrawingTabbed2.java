...
public class DrawingTabbed2 extends JFrame {
        ...
        addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                if (e.getButton() == MouseEvent.BUTTON3) {
                    popupMenu.show(DrawingTabbed2.this, e.getX(), e.getY());
                }
            }
        });
    ...
    private void changeFigure(JComponent newFigure) {
        ...
        if (currentFigure instanceof HilbertCurve || currentFigure instanceof MengerCarpet ||
                currentFigure instanceof SierpinskiTriangle || currentFigure instanceof Polynski) {
            figurasNormales.add((DrawingPanel) currentFigure);
        } else if (currentFigure instanceof HilbertCurveDinamic || currentFigure instanceof MengerCarpetDinamic ||
                currentFigure instanceof SierpinskiTriangleDinamic || currentFigure instanceof PolynskiDinamic) {
            figurasDinamicas.add((DrawingPanel) currentFigure);
        }
