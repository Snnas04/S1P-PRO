...
public class SierpinskiPanel2 extends JPanel {
    int width, height;
    Graphics2D graphics2D;

    public SierpinskiPanel2(int width, int height) {
        this.width = width;
        this.height = height;
    ...
    public void paint(Graphics graphics) {
        ...
        setBackground(new Color(15, 52, 202, 255));
        ...
        setForeground(new Color(202, 5, 5));
